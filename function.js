    ...
    document.getElementById('download').addEventListener('click', function() {
        ...
        html2pdf().set(opt).from(content).toPdf().get('pdf').then(function(pdf) {
            ...
            for (var i = 1; i <= pageCount; i++) {
                ...
                letterheadImg.src = 'URL_GAMBAR_LETTERHEAD';
                pdf.addImage(letterheadImg, 'PNG', 10, 10, 100, 40); // Ubah posisi dan ukuran sesuai kebutuhan
        
                // Add footer image
                var footerImg = new Image();
                footerImg.src = 'URL_GAMBAR_FOOTER';
                pdf.addImage(footerImg, 'PNG', 10, pdf.internal.pageSize.height - 50, 100, 40); // Ubah posisi dan ukuran sesuai kebutuhan
            }
